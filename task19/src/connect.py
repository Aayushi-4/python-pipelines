...
def load_aws_config(env_file=r'C:\Users\Aayushi\Documents\tasks\task21\config\config.env'):
...
def read_config(file_path=r'C:\Users\Aayushi\Documents\tasks\task21\config\config.ini'):
...
def get_gmail_service(credentials_path=r'C:\Users\Aayushi\Documents\tasks\task21\credentials.json', token_path='token.json'):
